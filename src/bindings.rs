...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.31.0:component:nana:example:encoded world"]
#[doc(hidden)]
...
@\0\0s\x04\0\x0bhello-world\x01\0\x04\x01\x16component:nana/example\x04\0\x0b\x0d\
